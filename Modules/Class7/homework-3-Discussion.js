...
sentence4_Titlecase += sentenceArray[0].charAt(0).toUpperCase() + sentenceArray[0].slice(1) + ' ';     // "" + Have + " " ->  "Have "

sentence4_Titlecase += sentenceArray[1].charAt(0).toUpperCase() + sentenceArray[1].slice(1) + ' ';   // "Have " + "A" + " " -> "Have A "

sentence4_Titlecase += sentenceArray[2].charAt(0).toUpperCase() + sentenceArray[2].slice(1) + ' ';   // "Have A " + "Great" + " " -> "Have A Great "

sentence4_Titlecase += sentenceArray[3].charAt(0).toUpperCase() + sentenceArray[3].slice(1) + ' ';   // "Have A Great " + "Day" + " " -> "Have A Great Day "
